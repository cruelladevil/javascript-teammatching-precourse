...
- 미션을 수행하며 각 레벨에서 전달하고자 하는 내요을 학습하는데 이 과정을 페어 프로그래밍으로 진행한다.
...
- 페어 매칭 조건
  ...
  - 같은 레벨에서 이미 페얼르 맺은 크루와는 다시 페어로 매칭될 수 없다.
  ```
...
- 페어 매칭 구현 방법
  ...
  - 같은 레벨에서 이미 페어로 만난적이 있는 크로끼리 다시 페어로 매칭 된다면 크루 목록의 순서를 다시 랜덤으로 섞어서 매칭을 시도한다.
